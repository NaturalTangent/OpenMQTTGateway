...
void setupPilight(){
    //receiving with Pilight is not compatible with ZgatewayRF or RF2 or RF315 as far as I can tell 
    #if !defined(ZgatewayRF) && !defined(ZgatewayRF2) && !defined(ZgatewayRF315)
