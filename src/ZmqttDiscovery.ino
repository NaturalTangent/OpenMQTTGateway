...
void pubMqttDiscovery()
{
  ...
  const char * BMEsensor[BMEparametersCount][8] = {
  ...
  trc(F("DHTDiscovery"));
  const char * DHTsensor[DHTparametersCount][8] = {
...
#ifdef ZsensorADC
  trc(F("ADCDiscovery"));
  const char * ADCsensor[8] = {"sensor", "adc", "adc", "","{{ value_json.adc }}","", "", ""};
     //component type,name,availability topic,device class,value template,payload on, payload off, unit of measurement
  ...
  const char * BH1750sensor[BH1750parametersCount][8] = {
  ...
  const char * TSL2561sensor[TSL2561parametersCount][8] = {
  ...
  const char * HCSR501sensor[8] = {"binary_sensor", "hcsr501", "hcsr501", "","","true", "false", ""};
     //component type,name,availability topic,device class,value template,payload on, payload off, unit of measurement
  ...
  const char * GPIOInputsensor[8] = {"binary_sensor", "GPIOInput", "GPIOInput", "","","true", "false", ""};
     //component type,name,availability topic,device class,value template,payload on, payload off, unit of measurement
  ...
  const char * INA226sensor[INA226parametersCount][8] = {
  ...
  const char * actuatorONOFF[8] = {"switch", "actuatorONOFF", "", "","","ON", "OFF", ""};
     //component type,name,availability topic,device class,value template,payload on, payload off, unit of measurement
  ...
  const char * gatewayRF[8] = {"sensor", "gatewayRF", "", "","{{ value_json.value }}","", "", ""};
     //component type,name,availability topic,device class,value template,payload on, payload off, unit of measurement
  ...
  const char * gatewayRF2[8] = {"sensor", "gatewayRF2", "", "","{{ value_json.value }}","", "", ""};
     //component type,name,availability topic,device class,value template,payload on, payload off, unit of measurement
  ...
  const char * gatewayRF315[8] = {"sensor", "gatewayRF315", "", "","{{ value_json.value }}","", "", ""};
     //component type,name,availability topic,device class,value template,payload on, payload off, unit of measurement
  ...
  const char * gatewayRFM69[8] = {"sensor", "gatewayRFM69", "", "","{{ value_json.value }}","", "", ""};
     //component type,name,availability topic,device class,value template,payload on, payload off, unit of measurement
  ...
  const char * gatewayLORA[8] = {"sensor", "gatewayLORA", "", "","{{ value_json.message }}","", "", ""};
     //component type,name,availability topic,device class,value template,payload on, payload off, unit of measurement
  ...
  const char * gatewayPilight[8] = {"sensor", "gatewayPilight", "", "","{{ value_json.message }}","", "", ""};
     //component type,name,availability topic,device class,value template,payload on, payload off, unit of measurement
  ...
  const char * gatewayIR[8] = {"sensor", "gatewayIR", "", "","{{ value_json.value }}","", "", ""};
     //component type,name,availability topic,device class,value template,payload on, payload off, unit of measurement
  ...
  const char * gateway2G[8] = {"sensor", "gateway2G", "", "","{{ value_json.message }}","", "", ""};
     //component type,name,availability topic,device class,value template,payload on, payload off, unit of measurement
